...
class TestOptunaResult(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        bench_1 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=1)))
        ...
        bench_2 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=1)))
        ...
        bench_r2 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=2)))
...
class TestOptunaOptimizeFlag(unittest.TestCase):
    ...
    def test_optimize_false_aggregation(self):
        ...
        cfg = _AggCfg()
        bench = cfg.to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=1)))
