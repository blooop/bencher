...
class TestHoloviewResult(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        bench1 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=1)))
        ...
        bench2 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=2)))
        ...
        bench3 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=1)))
        ...
        bench4 = BenchableObject().to_bench(bn.BenchRunCfg(execution=bn.ExecutionCfg(repeats=2)))
