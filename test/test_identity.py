...
class TestDocumentedFieldsMatchTheHashingRule(unittest.TestCase):
    ...
    def check_sample_order(self) -> None:
        ...
        self._assert_no_key_moves(
            _real_run(bn.BenchRunCfg(repeats=2), **decl, sample_order=bn.SampleOrder.INORDER),
            _real_run(bn.BenchRunCfg(repeats=2), **decl, sample_order=bn.SampleOrder.ROUND_ROBIN),
        )
