        ...
        while True:
            try:
                ...
                if film_strip_y:
                    ...
                    print(f"Frame {frame_count}: {len(frames_found)} frames, {labels_found} label pixels")
                    if frames_found:
...
if __name__ == "__main__":
    ...
    test_file = "cachedir/cartesian/cartesian_dim_1_3_dim_2_3_dim_3_2_dim_4_2_over_time_5_320x200.png"
