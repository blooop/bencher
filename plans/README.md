...
| 03 | [Repo hygiene](03-repo-hygiene.md) | Low | Small | **DONE** — PR #1043; see status note in the plan |
...
| 24 | [`assert_never` boundary discipline](24-assert-never-boundary-discipline.md) | Low | Small (amends 23) | **Read before 23-P1/P2/P11** — mostly DoD additions to plan 23; one small independent phase (Q1, pin half landed in 26-R10, probe still open) |
