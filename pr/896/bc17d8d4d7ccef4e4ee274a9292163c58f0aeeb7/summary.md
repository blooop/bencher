...
| Test | Time (s) |
|------|----------|
| `test.test_bench_examples.TestBenchExamples::test_example_meta` | 21.223 |
| `test.test_over_time_save_perf::test_save_faster_without_aggregated_tab` | 5.138 |
...
| `test.test_over_time_repeats.TestMaxSliderPoints::test_default_subsampling_caps_at_max` | 3.006 |
| `test.test_generated_examples::test_generated_example[result_types/result_image/example_result_image_to_video.py]` | 2.816 |
| `test.test_bencher.TestBencher::test_combinations_over_time` | 1.542 |
