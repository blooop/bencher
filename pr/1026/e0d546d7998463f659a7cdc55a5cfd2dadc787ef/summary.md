...
| `test.test_split_render_examples::test_split_render_subprocess_media` | 6.373 |
...
| `test.test_over_time_save_perf::test_save_faster_without_aggregated_tab` | 4.218 |
| `test.test_generated_examples::test_generated_example[cartesian_animation/example_cartesian_animation.py]` | 3.111 |
| `test.test_generated_examples::test_generated_example[regression/example_regression_tuning_noise.py]` | 3.098 |
