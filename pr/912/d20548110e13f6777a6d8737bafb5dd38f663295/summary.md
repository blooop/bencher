...
| Test | Time (s) |
|------|----------|
| `test.test_bench_examples.TestBenchExamples::test_example_meta` | 20.440 |
| `test.test_over_time_save_perf::test_save_faster_without_aggregated_tab` | 5.171 |
...
| `test.test_bencher.TestBencher::test_combinations_over_time` | 1.405 |
| `test.test_optuna_result.TestOptunaResult::test_collect_optuna_plots_with_repeats` | 1.040 |
| `test.test_over_time_repeats.TestCurveResultOverTime::test_curve_over_time_no_repeats` | 1.025 |
