...
| Test | Time (s) |
|------|----------|
| `test.test_bench_examples.TestBenchExamples::test_example_meta` | 22.949 |
...
| `test.test_generated_examples::test_generated_example[cartesian_animation/cartesian_animation.py]` | 3.079 |
...
| `test.test_bencher.TestBencher::test_combinations_over_time` | 1.211 |
