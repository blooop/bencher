...
| Test | Time (s) |
|------|----------|
| `test.test_bench_examples.TestBenchExamples::test_example_meta` | 16.886 |
| `test.test_over_time_save_perf::test_save_faster_without_aggregated_tab` | 5.434 |
...
| `test.test_generated_examples::test_generated_example[regression/example_regression_tuning_drift.py]` | 3.114 |
| `test.test_generated_examples::test_generated_example[regression/example_regression_tuning_step.py]` | 2.897 |
...
| `test.test_over_time_repeats.TestMaxSliderPoints::test_default_subsampling_caps_at_max` | 2.394 |
