...
def example_floats2D_workflow(run_cfg: bch.BenchRunCfg, bench: bch.Bench | None = None) -> bch.Bench:
...
def example_floats3D_workflow(run_cfg: bch.BenchRunCfg, bench: bch.Bench | None = None) -> bch.Bench:
    """Example of how to perform a 3D floating point parameter sweep
