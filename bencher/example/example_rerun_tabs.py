...
def example_rerun_tabs(run_cfg: bch.BenchRunCfg = None, report: bch.BenchReport = None) -> bch.Bench:
    ...
    print("Check the Rerun viewer window that opened - it should show tabs with the different theta values!")
