...
def example_image_vid(
    ...
    # bench.add_plot_callback(bn.BenchResult.to_video_summary)
    # bench.add_plot_callback(bn.BenchResult.to_video_grid, time_sequence_dimension=0)
    # bench.add_plot_callback(bn.BenchResult.to_video_grid)
    # bench.add_plot_callback(bn.BenchResult.to_video_grid, time_sequence_dimension=2)
    # bench.add_plot_callback(bn.BenchResult.to_video_grid, time_sequence_dimension=3)
...
if __name__ == "__main__":
    ...
    def simple(
        ...
        bench = BenchPolygons().to_bench(run_cfg or bn.BenchRunCfg(level=4), report=report)
    ...
    def example_image_vid_sequential(
        ...
        bench = BenchPolygons().to_bench(run_cfg, report)
        bench.add_plot_callback(bn.BenchResult.to_title)
        bench.add_plot_callback(bn.BenchResult.to_video_grid)
