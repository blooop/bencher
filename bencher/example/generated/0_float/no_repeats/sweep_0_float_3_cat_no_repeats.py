...
def example_sweep_0_float_3_cat_no_repeats(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    bench.plot_sweep(
        ...
        description=(
            "A 0 float + 3 categorical parameter sweep with a single sample per combination. "
            ...
            "committing to longer runs. Categorical-only sweeps produce bar/swarm plots "
            "comparing discrete settings."
        ),
        post_description=(
