...
def example_sweep_0_float_0_cat_no_repeats(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    bench.plot_sweep(
        ...
        description=(
            "A 0 float + 0 categorical parameter sweep with a single sample per combination. "
            ...
            "committing to longer runs. With no input variables, this is a 0D sweep that "
            "measures a single baseline metric."
        ),
        post_description=(
