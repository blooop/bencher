...
def example_composable_dataset_right(run_cfg: bch.BenchRunCfg | None = None) -> bch.Bench:
    """Composable Dataset: ComposeType.right."""
...
if __name__ == "__main__":
    bch.run(example_composable_dataset_right, level=3)
