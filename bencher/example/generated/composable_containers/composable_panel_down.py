...
def example_composable_panel_down(run_cfg: bch.BenchRunCfg | None = None) -> bch.Bench:
    """Composable Panel: ComposeType.down."""
    bench = _PanelComposeDemo().to_bench(run_cfg)
    bench.plot_sweep(
        title="Panel Layout: ComposeType.down",
...
if __name__ == "__main__":
    bch.run(example_composable_panel_down, level=2)
