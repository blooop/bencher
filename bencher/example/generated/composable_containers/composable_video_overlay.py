...
def example_composable_video_overlay(run_cfg: bch.BenchRunCfg | None = None) -> bch.Bench:
    """Composable Video: ComposeType.overlay."""
...
if __name__ == "__main__":
    bch.run(example_composable_video_overlay, level=2)
