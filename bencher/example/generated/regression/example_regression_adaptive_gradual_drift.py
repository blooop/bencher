"""Auto-generated example: Adaptive detection — gradual long-term drift (drift test fires)."""
...
def example_regression_adaptive_gradual_drift(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
...
if __name__ == "__main__":
    bn.run(example_regression_adaptive_gradual_drift, over_time=True)
