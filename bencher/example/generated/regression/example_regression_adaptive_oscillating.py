"""Auto-generated example: Adaptive detection — oscillating periodic signal (no false positive)."""
...
def example_regression_adaptive_oscillating(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    schedule = [
        (0.0, 2.0),
        (8.660254037844386, 2.0),
        (8.660254037844387, 2.0),
        (1.2246467991473533e-15, 2.0),
        (-8.660254037844384, 2.0),
        (-8.660254037844386, 2.0),
        (-2.4492935982947065e-15, 2.0),
        (8.660254037844384, 2.0),
        (8.66025403784439, 2.0),
        (3.673940397442059e-15, 2.0),
        (-8.660254037844387, 2.0),
        (-8.66025403784439, 2.0),
        (-4.898587196589413e-15, 2.0),
        (8.660254037844387, 2.0),
        (8.660254037844393, 2.0),
        (2.3886802389739268e-14, 2.0),
        (-8.660254037844377, 2.0),
        (-8.660254037844384, 2.0),
    ]
...
if __name__ == "__main__":
    bn.run(example_regression_adaptive_oscillating, over_time=True)
