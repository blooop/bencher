"""Auto-generated example: Adaptive detection — isolated historical outlier ignored."""
...
def example_regression_adaptive_outlier_immune(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
...
if __name__ == "__main__":
    bn.run(example_regression_adaptive_outlier_immune, over_time=True)
