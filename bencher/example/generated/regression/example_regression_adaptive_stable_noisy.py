"""Auto-generated example: Adaptive detection — noisy-but-stable signal (no false positive)."""
...
def example_regression_adaptive_stable_noisy(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
...
if __name__ == "__main__":
    bn.run(example_regression_adaptive_stable_noisy, over_time=True)
