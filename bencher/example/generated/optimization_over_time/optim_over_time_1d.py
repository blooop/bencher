...
def example_optim_over_time_1d(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    for i in range(4):
        ...
        bench.plot_sweep(
            ...
            description=(
                "Optimization over 1D input space with temporal drift. Performance degrades over "
                "successive runs. The importance analysis shows repeat, over_time, and input "
                "parameters — revealing whether noise or temporal drift dominates."
            ),
            post_description=(
