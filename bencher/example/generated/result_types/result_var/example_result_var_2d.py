...
def example_result_var_2d(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    bench.plot_sweep(
        input_vars=["endpoint", "concurrency"],
        result_vars=["latency"],
        description="Demonstrates a scalar numeric metric with units with 2D input sweep.",
    )
...
if __name__ == "__main__":
    bn.run(example_result_var_2d, subsampling_divisions=2)
