...
def example_sweep_3_float_2_cat_over_time(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
    ...
    for i, offset in enumerate([0.0, 0.5, 1.0]):
        ...
        res = bench.plot_sweep(
            ...
            description=(
                "A 3 float + 2 categorical parameter sweep tracked over time. Setting "
                ...
                "force re-evaluation. A 3D float sweep produces a volumetric representation. This "
                "is useful for visualising scalar fields in 3D parameter spaces."
            ),
            post_description=(
