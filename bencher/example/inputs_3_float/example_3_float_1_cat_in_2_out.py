...
def example_3_float_1_cat_in_2_out(run_cfg: bch.BenchRunCfg | None = None) -> bch.Bench:
    ...
    bench = Pattern3DModel1Cat().to_bench(run_cfg)
    bench.plot_sweep(
...
if __name__ == "__main__":
    bch.run(example_3_float_1_cat_in_2_out)
