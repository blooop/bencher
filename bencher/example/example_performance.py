...
class CachePerformance(bch.ParametrizedSweep):
    ...
    def __call__(self, **kwargs):
        ...
        res = bench.plot_sweep(input_vars=["x"], result_vars=["out"])
        self.cold_time_ms = res.timings.total_ms
        ...
        self.warm_time_ms = res2.timings.total_ms
