...
class SimpleFloat(bn.ParametrizedSweep):
    ...
    offset = bn.FloatSweep(default=0, bounds=[0, 1], doc="Input angle offset", units="rad")
    noise = bn.FloatSweep(default=0, bounds=[0, 1], doc="noise", units="rad")
...
def example_2D_float_const(run_cfg: bn.BenchRunCfg | None = None) -> bn.Bench:
