...
class BarMeanResult(HoloviewResult):
    ...
    def to_plot(
        ...
        return self.to_bar_mean(result_var, override, **kwargs)
    ...
    def to_bar_mean_ds(self, dataset: xr.Dataset, result_var: Parameter = None, **kwargs):
