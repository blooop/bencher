...
from bencher.bench_cfg import BenchCfg, ServerCfg, ShowMode, normalize_show
...
class BenchPlotServer:
    ...
    def plot_server(
        self, bench_name: str, plot_cfg: ServerCfg | None = None, plots_instance=None
    ) -> Thread:
        ...
        Args:
            ...
            plot_cfg (ServerCfg, optional): Options for the plot server. Defaults to None.
