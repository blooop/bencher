...
def test_generic_dimensions():
    ...
    for ndims in range(1, 16):
        ...
        assert actual_value == test_value, f"Failed for {ndims}D: expected {test_value}, got {actual_value}"
    ...
    print(f"   Previously it was hardcoded to only work up to 9 dimensions.")
